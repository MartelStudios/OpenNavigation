plugins {
    idea
    java
    // The mod itself, not a workspace of them: hytale-tools builds this project, where
    // hytale-workspace only ties several mod projects together and has none to tie here.
